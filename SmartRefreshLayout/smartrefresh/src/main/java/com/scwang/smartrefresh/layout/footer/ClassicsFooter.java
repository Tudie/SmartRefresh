...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    public static String REFRESH_FOOTER_RELEASE = "松开加载更多";
    public static String REFRESH_FOOTER_LOADING = "加载中...";
    public static String REFRESH_FOOTER_REFRESHING = "正在刷新...";
    public static String REFRESH_FOOTER_FINISH = "";//刷新完成
    public static String REFRESH_FOOTER_FAILED = "";//刷新完成
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTitleText.setTextColor(0xff7c7c7c);
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlDrawableArrow)) {
            ...
            mArrowDrawable.parserColors(0xffC0C0C0);
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlDrawableProgress)) {
            ...
            mProgressDrawable.setColor(0xffC0C0C0);
